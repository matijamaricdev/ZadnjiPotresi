...
{
    public class AboveTwoController : Controller
    {
        ...
        private List<string> AllEarthQuakesIznad3(IHtmlDocument document)
        {
            ...
            PotresiMagnituzaIznadTri(returnAllEarthQuakes, allEarthQuakesMag2, allEarthQuakesMag3, allEarthQuakesMag4, allEarthQuakesMag5, allEarthQuakesMag6);

            return returnAllEarthQuakes;
        }

        private static void PotresiMagnituzaIznadTri(List<string> returnAllEarthQuakes, IEnumerable<IElement> allEarthQuakesMag2, IEnumerable<IElement> allEarthQuakesMag3, IEnumerable<IElement> allEarthQuakesMag4, IEnumerable<IElement> allEarthQuakesMag5, IEnumerable<IElement> allEarthQuakesMag6)
        {
