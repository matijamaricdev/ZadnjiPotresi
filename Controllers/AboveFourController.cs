...
{
    public class AboveFourController : Controller
    {
        ...
        private List<string> AllEarthQuakesIznad3(IHtmlDocument document)
        {
            ...
            PotresiMagnituzaIznadTri(returnAllEarthQuakes, allEarthQuakesMag4, allEarthQuakesMag5, allEarthQuakesMag6);

            return returnAllEarthQuakes;
        }

        private static void PotresiMagnituzaIznadTri(List<string> returnAllEarthQuakes, IEnumerable<IElement> allEarthQuakesMag4, IEnumerable<IElement> allEarthQuakesMag5, IEnumerable<IElement> allEarthQuakesMag6)
        {
