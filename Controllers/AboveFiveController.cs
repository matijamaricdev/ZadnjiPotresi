...
{
    public class AboveFiveController : Controller
    {
        ...
        private List<string> AllEarthQuakesIznad3(IHtmlDocument document)
        {
            ...
            PotresiMagnituzaIznadTri(returnAllEarthQuakes, allEarthQuakesMag5, allEarthQuakesMag6);

            return returnAllEarthQuakes;
        }

        private static void PotresiMagnituzaIznadTri(List<string> returnAllEarthQuakes, IEnumerable<IElement> allEarthQuakesMag5, IEnumerable<IElement> allEarthQuakesMag6)
        {
